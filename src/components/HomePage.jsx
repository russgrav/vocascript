  ...
  return (
    <main className="flex-1 p-4 flex flex-col gap-3 sm:gap-4 md:gap-5 justify-center text-center pb-20">
      <h1 className="font-semibold text-5xl sm:text-6xl md:text-7xl">
        Voca<span className="text-blue-400 bold">Script</span>
      </h1>
      ...
      <button
        ...
        className="flex items-center specialBtn px-4 py-2 rounded-xl text-blue-400 text-base justify-between gap-4 mx-auto w-72 max-w-full my-4"
      >
